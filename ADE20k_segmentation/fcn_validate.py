...
class Custom_dataset(torch.utils.data.Dataset):
    def __init__(self , images , masks, means= None, n_class=13):
        self.imgs = images
        self.masks = masks
        self.means = means
        self.n_class = n_class
...
valid_data = Custom_dataset(training_image_paths,
                            training_annotation_paths)

train_loader = torch.utils.data.DataLoader(valid_data, batch_size=8,
                                          shuffle=True,
