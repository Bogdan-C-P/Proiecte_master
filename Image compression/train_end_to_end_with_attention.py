...
class End_to_end_with_attention(nn.Module):
    def __init__(self):
        super(End_to_end_with_attention, self).__init__()
...
if __name__ == '__main__':
    ...
    num_epochs = 100
    learning_rate = 1e-4
    model = End_to_end_with_attention().cuda()
    ...
    for epoch in range(num_epochs):
        ...
        # ===================save========================
        torch.save(model.state_dict(), 'End_to_end_with_attention.pth')
