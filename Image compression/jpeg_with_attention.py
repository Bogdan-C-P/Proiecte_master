...
class JPG_with_attention(nn.Module):
    def __init__(self):
        super(JPG_with_attention, self).__init__()
    ...
    def forward(self, x):
        ...
        with torch.no_grad():
            for i in range(batch_size):
                compressed_img_torch = apply_jpeg_on_encoding(attention_map[i])
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        # ===================save========================
        torch.save(model.state_dict(), 'jpeg_with_attention.pth')
